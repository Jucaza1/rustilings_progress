...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        // for x in [tuple.0,tuple.1,tuple.2].into_iter(){
        //     vec_u8.push({
        //         match x{
        //             x if x<0 => return Err(IntoColorError::IntConversion),
        //             x if x>u8::MAX.into() => return Err(IntoColorError::IntConversion),
        //             x => x as u8iiiiiiiii,
        //         }
        //     });
        // }
        // // let [red, green, blue]:&[u8] = slice
        // //     .try_into()
        // //     .map_err(|_| IntoColorError::IntConversion)?;
        // Ok(Self { red: vec_u8[0], green:vec_u8[1], blue: vec_u8[2] })
